...
@Slf4j
@Controller
@RequestMapping("/usquestion")
public class UsQuestionController {
	...
	@Autowired
	public UsQuestionController(QuestionRepository questionRepo,CommentQRepository commentQRepo, AnswerRepository answerRepo, CommentARepository commentARepo) {
